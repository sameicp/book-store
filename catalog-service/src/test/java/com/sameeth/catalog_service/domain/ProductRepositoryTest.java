...
class ProductRepositoryTest {
    ...
    void shouldGetProductByCode() {
        ...
        Assertions.assertThat(product.getDescription()).isEqualTo("A series of fantasy novels where children discover a magical world accessible through a wardrobe.");
